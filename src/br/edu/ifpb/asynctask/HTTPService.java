...
private static final String URL_CONTEXT = "http://192.168.1.245:8443/nutrif/NutrIF_service/";
	...
	public static String getHttpContent(HttpURLConnection connection){
        ...
        try {
            ...
            if(((HttpURLConnection) connection).getResponseCode() <= HttpURLConnection.HTTP_BAD_REQUEST)
                content = ((URLConnection) connection).getInputStream();
            else
                content = ((HttpURLConnection) connection).getErrorStream();
	...
	public HttpResponse sendJsonPostRequest(String string, JSONObject jsonObject) {
